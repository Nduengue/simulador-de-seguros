...
<body>
    ...
    <section>
        ...
        <article>
            ...
            <div class="article-content">
                <div class="follow-up">
                     dos prejuízos indemnizáveis, no mínimo de .
                </div>
            </div>
        </article>
            ...
            <div class="article-content">
                <div class="follow-up">
                    <ul style="margin: 0; padding:0; list-style-type: none;">
                        <li>Fracionamento Semestral: AOA </li>
                        <li>Premio Anual Não Estornável: AOA  </li>
                    </ul>
                </div>
            </div>
        </article>
        ...
        <article>
            ...
            <div class="article-content">
                <div class="follow-up">
                    Taxa Total: % aplicável ao valor transportado por transporte e viagem
                </div>
            </div>
        </article>
        ...
        <p class="p-date-time text-right">Luanda, </p>
