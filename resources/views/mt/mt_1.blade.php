...
<body>
    ...
    <div class="container">
        <div class="no-first-page">
            ...
            <div class="page">
                <div class="section">
                    <div class="section-title"> DADOS DO TOMADOR SEGURO E SEGURO </div>
            ...
            <div class="page">
                <div class="section">
                    <div class="section-title"> OBJECTO DO CONTRATO </div>
                    <div class="section-content">
                        <ul class="ul">
                            <li class="li">A presente proposta de seguro determina a obrigação de indemnizar até ao
                                montante do capital seguro, as perdas ou danos, decorrentes de qualquer
            ...
            <div class="page">
                <div class="section">
                    <div class="section-title"> TIPO DE MERCADORIA </div>
                    <div class="section-content">
                        <ul class="ul">
                            <li class="li">{{ $dados['merchandise']['name'] }}</li>
                        </ul>
            ...
            <div class="page">
                <div class="section">
                    <div class="section-title"> ÂMBITO TERRITORIAL </div>
                    <div class="section-content">
                        <ul class="ul">
                            @foreach ($dados['ways']['options'] as $way_options)
                                <li class="li">{{ $way_options['name'] }}</li>
            ...
            <div class="page">
                <div class="section">
                    <div class="section-title"> GARANTIAS DO CONTRATO </div>
                    <div class="section-content">
                        <ul class="ul">
                            <li class="li"><span>Nos termos e até aos limites fixados nas Condições Particulares da
                                    Apólice é
            ...
            <div class="page">
                <div class="section">
                    <div class="section-title"> VALORES SEGUROS </div>
                    <div class="section-content">
                        <table style="width: 100%; border-collapse: collapse;">
                            <tr>
                                <td style="text-align: left; padding: 10px; border: none;">{{ $dados['value'] }}</td>
            ...
            <div class="page">
                <div class="section">
                    ...
                    <div class="section-content">
                        <ul class="ul">
                            <li class="li"><span> Valor da Cobertura: </span></li>
                            <li class="li"><span>Duração em Anos: </span>
                            </li>
                        </ul>
                    </div>
