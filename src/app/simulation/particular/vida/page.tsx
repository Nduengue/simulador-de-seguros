        ...
        <form className=" space-y-2.5">
          ...
          <div className="space-y-2">
            ...
            {/* <Radio.Group
              ...
              buttonStyle="solid"
            /> */}
            <Radio.Group className="*:border *:rounded-xl *:p-3 *:text-gray-600 font-bold  rounded-xl *:border-[#fba94c] *:flex-1 *:items-center *:justify-center flex items-center ">
              <Radio value="1" className=" has-[:checked]:bg-[#fb923c] has-[:checked]:text-gray-50">👨‍🦰Masculino</Radio>
              <Radio value="2" className=" has-[:checked]:bg-[#fb923c] has-[:checked]:text-gray-50">👩‍🦰Femenino</Radio>
            </Radio.Group>
          </div>
