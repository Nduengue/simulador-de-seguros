...
# ==============================================================================
def current_date_time(): return datetime.now(timezone.utc)


# ==============================================================================
def generate_unique_id(alchemy_obj, db_session):
    while True:
        new_id = str(uuid.uuid4())
        existing_id = db_session.query(alchemy_obj).filter_by(id=new_id).first()
        if not existing_id:
            return new_id
...
# ==============================================================================
def convert_utc_to_local(utc_datetime, target_timezone='Africa/Luanda', date_format=None):
    """
